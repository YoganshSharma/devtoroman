#!/usr/bin/env python
"""
Devnagri to Roman transliteration CLI
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Devnagri to Roman transliteration"
    )
    parser.add_argument(
        'infile', nargs='?',
    ...
    if args.infile:
        if not os.path.isfile(args.infile):
            sys.exit(f"Error: input file '{args.infile}' not found.")
